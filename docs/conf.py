...
htmlhelp_basename = 'widefaceaidoc'
...
latex_documents = [
    (master_doc, 'widefaceai.tex', 'wideface.ai Documentation',
     'Thanh Nguyen', 'manual'),
]
...
man_pages = [
    (master_doc, 'widefaceai', 'wideface.ai Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'widefaceai', 'wideface.ai Documentation',
     author, 'widefaceai', 'One line description of project.',
     'Miscellaneous'),
]
